/*
  ...
  - You are about to drop the `TriviaQuiz` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `TriviaRound` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `TriviaRoundQuiz` table. If the table is not empty, all the data it contains will be lost.
...
-- DropForeignKey
ALTER TABLE "TriviaQuiz" DROP CONSTRAINT "TriviaQuiz_answerChoiceId_fkey";

-- DropForeignKey
ALTER TABLE "TriviaQuiz" DROP CONSTRAINT "TriviaQuiz_categoryName_fkey";

-- DropForeignKey
ALTER TABLE "TriviaRound" DROP CONSTRAINT "TriviaRound_categoryName_fkey";

-- DropForeignKey
ALTER TABLE "TriviaRoundQuiz" DROP CONSTRAINT "TriviaRoundQuiz_quizId_fkey";

-- DropForeignKey
ALTER TABLE "TriviaRoundQuiz" DROP CONSTRAINT "TriviaRoundQuiz_roundId_fkey";

-- DropForeignKey
ALTER TABLE "TriviaRoundQuiz" DROP CONSTRAINT "TriviaRoundQuiz_userChoiceId_fkey";
...
-- DropTable
DROP TABLE "TriviaQuiz";

-- DropTable
DROP TABLE "TriviaRound";

-- DropTable
DROP TABLE "TriviaRoundQuiz";
